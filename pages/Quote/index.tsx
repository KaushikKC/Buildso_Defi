...
export default function QuoteView({
  ...
  return (
    <div className="p-3 mx-auto max-w-screen-sm pt-24">
      <form>
        <div className="bg-slate-200 dark:bg-gray-600/45 p-4 rounded-sm mb-3">
      ...
      <button
        className="bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white font-bold py-2 px-4 rounded w-full"
        onClick={() => {
